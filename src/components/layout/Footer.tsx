  ...
  return (
    <footer className="bg-white border-t border-border-custom mt-auto font-sans">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-[14px]">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="max-w-sm">
              ...
              <p className="text-[12px] text-slate mb-4 font-normal">Stay informed about our latest research and events.</p>
              <SubscribeForm />
            </div>
          </div>
          <div>
            <h3 className="text-navy font-medium uppercase tracking-wider mb-4">Navigation</h3>
          ...
          <div>
            <h3 className="text-navy font-medium uppercase tracking-wider mb-4">Legal</h3>
            <ul className="space-y-2 font-normal">
        ...
        <div className="mt-8 border-t border-border-custom pt-8 flex flex-col md:flex-row justify-between items-center text-slate text-[12px] font-normal">
